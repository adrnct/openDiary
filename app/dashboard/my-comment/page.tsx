...
const page = async () => {
    ...
    return (
        <Wrapper title={commentsByEmails.length > 0 ? 'All comments' : 'Comment not available'}>
                                ...
                                <div className='flex justify-between gap-4'>
                                    <div className='flex gap-4'>
                                        <div className='items-center gap-4'>
                                            <Image src={comment.avatar as string} alt={comment.avatar as string} width={45} height={45} className='rounded-full bg-primary p-2' />
                                        </div>
                                        <div className='max-w-[150px] md:max-w-[600px]'>
                                            <p className='font-bold mb-2'>{comment.username || comment.email}</p>
                                            <p>{comment.content}</p>
                                        </div>
                                    </div>
                                </div>
